import type { Campaign, CreateCampaignPayload, ActivityLog, Suggestion } from "./types"
...
export async function updateCampaignStatus(id: string, status: "active" | "paused" | "ended"): Promise<Campaign> {
  await delay(500)
